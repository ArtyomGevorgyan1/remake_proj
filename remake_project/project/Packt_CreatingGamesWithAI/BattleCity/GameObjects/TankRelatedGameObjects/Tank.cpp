...
{
    if( MathCommons::definitelyGreaterThan( std::fabs(this->mHeadingVector.y), MathCommons::EPSILON)  )
    {
    ...
    else if( MathCommons::definitelyGreaterThan( std::fabs(this->mHeadingVector.x), MathCommons::EPSILON)  )
    {
